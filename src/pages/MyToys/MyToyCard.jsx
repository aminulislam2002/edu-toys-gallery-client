...
const MyToyCard = ({ myToy }) => {
  const { name, category, title, photoURL, sellerName, price, sellerEmail, quantity, description, ratings } = myToy;
  return (
      ...
      <div className="card hover:shadow-2xl w-full bg-base-200 shadow-xl">
        ...
        <div className="flex flex-col gap-5 p-3">
          ...
          <div className="card-actions justify-end">
            <Link>
              <button className="btn bg-yellow-500 hover:bg-yellow-700 border-none ">Update</button>
            </Link>
            <Link>
